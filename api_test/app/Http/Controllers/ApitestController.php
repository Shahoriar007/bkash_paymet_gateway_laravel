...
class ApitestController extends Controller
{
    ...
    $paymentData = $this->createPayment($id_token, $app_key, $price, $invoice, $callBackURL, $phnNumber);
    ...
    // Create Payment
public function createPayment($id_token, $app_key, $price, $invoice, $callBackURL, $phnNumber){
